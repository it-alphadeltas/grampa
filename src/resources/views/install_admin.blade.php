...
<head>
    ...
    <title>{{ config('shopify-app.app_name') }} Installation</title>
...
<main class="container" role="main">
    <header>
        <h1>{{ config('shopify-app.app_name') }} Installation</h1>
        <p class="subhead">
    ...
    <div class="container__form">
        <form class="form-horizontal" method="POST" action="{{ route('authenticate-admin') }}">
            {{ csrf_field() }}
